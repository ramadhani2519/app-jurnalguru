...
<div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
    <h5 class="mb-0">
        ...
        Catat Tindak Lanjut Pembinaan
    </h5>
    <a href="<?= base_url('guru-wali/siswa-saya') ?>" class="btn btn-sm btn-light">
...
<div class="alert alert-warning d-flex align-items-center gap-2">
    ...
    <div>
        ...
        sudah tercatat <strong><?= $jumlahPelanggaran ?> kali</strong> di data pelanggaran dan memerlukan tindakan pembinaan.
    </div>
</div>

<form method="post" action="<?= base_url('guru-wali/pembinaan/simpan') ?>" enctype="multipart/form-data">

    <input type="hidden" name="siswa_id" value="<?= esc($siswa['siswa_id']) ?>">
    ...
    <div class="d-flex justify-content-end gap-2">
        <a href="<?= base_url('guru-wali/siswa-saya') ?>" class="btn btn-secondary">Batal</a>
