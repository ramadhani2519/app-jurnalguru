...
<div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
    ...
    <a href="<?= base_url('wali-kelas-binaan/siswa') ?>" class="btn btn-sm btn-light">
...
<div class="alert alert-warning d-flex align-items-center gap-2">
    ...
    <div>
        ...
        Guru Wali, dan sekarang memerlukan tindakan pembinaan dari Wali Kelas.
    </div>
</div>

<form method="post" action="<?= base_url('wali-kelas-binaan/pembinaan/simpan') ?>" enctype="multipart/form-data">
    ...
    <div class="d-flex justify-content-end gap-2">
        <a href="<?= base_url('wali-kelas-binaan/siswa') ?>" class="btn btn-secondary">Batal</a>
